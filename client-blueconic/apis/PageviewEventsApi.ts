...
import {
    PageViewEventBeanFromJSON,
    PageViewEventBeanToJSON,
} from '../models/index.js';

export interface CreatePageviewEventRequest {
    pageViewEventBean: PageViewEventBean;
}

/**
 * 
 */
export class PageviewEventsApi extends runtime.BaseAPI {

    /**
     * Register that a profile visited a certain web page.
     * Create page view event
     */
    async createPageviewEventRaw(requestParameters: CreatePageviewEventRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters['pageViewEventBean'] == null) {
            throw new runtime.RequiredError(
                'pageViewEventBean',
                'Required parameter "pageViewEventBean" was null or undefined when calling createPageviewEvent().'
            );
        }
        ...
        const response = await this.request({
            ...
            body: PageViewEventBeanToJSON(requestParameters['pageViewEventBean']),
        }, initOverrides);
     ...
     * Create page view event
     */
    async createPageviewEvent(requestParameters: CreatePageviewEventRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.createPageviewEventRaw(requestParameters, initOverrides);
    }
