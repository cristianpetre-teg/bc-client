...
export class InteractionsApi extends runtime.BaseAPI {
     ...
     * Get interactions
     */
    async getInteractionsRaw(requestParameters: GetInteractionsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Interactions>> {
        if (requestParameters['url'] == null) {
            throw new runtime.RequiredError(
                'url',
                'Required parameter "url" was null or undefined when calling getInteractions().'
            );
        }
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => InteractionsFromJSON(jsonValue));
    }

    /**
     * Get interactions
     */
    async getInteractions(requestParameters: GetInteractionsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Interactions> {
        const response = await this.getInteractionsRaw(requestParameters, initOverrides);
