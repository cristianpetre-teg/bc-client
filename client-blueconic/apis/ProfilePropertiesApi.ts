...
import {
    ProfilePropertiesFromJSON,
    ProfilePropertiesToJSON,
    ProfilePropertyFromJSON,
    ProfilePropertyToJSON,
} from '../models/index.js';

export interface CreateOrUpdateProfilePropertyRequest {
    profilePropertyId: string;
    profileProperty: ProfileProperty;
}

export interface DeleteProfilePropertyRequest {
    profilePropertyId: string;
}

export interface GetProfilePropertiesRequest {
    count?: number;
    startIndex?: number;
    filterType?: Array<GetProfilePropertiesFilterTypeEnum>;
    filterValue?: string;
}

export interface GetProfilePropertyRequest {
    profilePropertyId: string;
}
 ...
 * 
 */
export class ProfilePropertiesApi extends runtime.BaseAPI {

    /**
     * Create/update profile property
     */
    async createOrUpdateProfilePropertyRaw(requestParameters: CreateOrUpdateProfilePropertyRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ProfileProperty>> {
        if (requestParameters['profilePropertyId'] == null) {
            throw new runtime.RequiredError(
                'profilePropertyId',
                'Required parameter "profilePropertyId" was null or undefined when calling createOrUpdateProfileProperty().'
            );
        }

        if (requestParameters['profileProperty'] == null) {
            throw new runtime.RequiredError(
                'profileProperty',
                'Required parameter "profileProperty" was null or undefined when calling createOrUpdateProfileProperty().'
            );
        }
        ...
        const response = await this.request({
            path: `/profileProperties/{profilePropertyId}`.replace(`{${"profilePropertyId"}}`, encodeURIComponent(String(requestParameters['profilePropertyId']))),
            method: 'PUT',
            headers: headerParameters,
            query: queryParameters,
            body: ProfilePropertyToJSON(requestParameters['profileProperty']),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => ProfilePropertyFromJSON(jsonValue));
    }

    /**
     * Create/update profile property
     */
    async createOrUpdateProfileProperty(requestParameters: CreateOrUpdateProfilePropertyRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ProfileProperty> {
        const response = await this.createOrUpdateProfilePropertyRaw(requestParameters, initOverrides);
     ...
     */
    async deleteProfilePropertyRaw(requestParameters: DeleteProfilePropertyRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ProfileProperty>> {
        if (requestParameters['profilePropertyId'] == null) {
            throw new runtime.RequiredError(
                'profilePropertyId',
                'Required parameter "profilePropertyId" was null or undefined when calling deleteProfileProperty().'
            );
        }
     ...
     * Delete profile property
     */
    async deleteProfileProperty(requestParameters: DeleteProfilePropertyRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ProfileProperty> {
        const response = await this.deleteProfilePropertyRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async getProfilePropertiesRaw(requestParameters: GetProfilePropertiesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ProfileProperties>> {
        const queryParameters: any = {};
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ProfilePropertiesFromJSON(jsonValue));
    }
     ...
     * Get all profile properties
     */
    async getProfileProperties(requestParameters: GetProfilePropertiesRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ProfileProperties> {
        const response = await this.getProfilePropertiesRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async getProfilePropertyRaw(requestParameters: GetProfilePropertyRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ProfileProperty>> {
        if (requestParameters['profilePropertyId'] == null) {
            throw new runtime.RequiredError(
                'profilePropertyId',
                'Required parameter "profilePropertyId" was null or undefined when calling getProfileProperty().'
            );
        }
     ...
     * Get one profile property
     */
    async getProfileProperty(requestParameters: GetProfilePropertyRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ProfileProperty> {
        const response = await this.getProfilePropertyRaw(requestParameters, initOverrides);
        return await response.value();
    }
 ...
 * @export
 */
export const GetProfilePropertiesFilterTypeEnum = {
    Range: 'RANGE',
    Currency: 'CURRENCY',
    Decimal: 'DECIMAL',
    Select: 'SELECT',
...
export type GetProfilePropertiesFilterTypeEnum = typeof GetProfilePropertiesFilterTypeEnum[keyof typeof GetProfilePropertiesFilterTypeEnum];
