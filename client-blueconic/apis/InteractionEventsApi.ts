...
import {
    InteractionEventBeanFromJSON,
    InteractionEventBeanToJSON,
} from '../models/index.js';

export interface CreateEventRequest {
    interactionEventBean: InteractionEventBean;
}

/**
 * 
 */
export class InteractionEventsApi extends runtime.BaseAPI {

    /**
     * Register an interaction event for a profile. When optional parameter `profile` is set, the interaction ID will be added to the profile property \"interactions_viewed\" (in case of \"VIEW\"), \"interactions_clicked\" (in case of \"CLICK\"), or \"interactions_converted\" (in case of \"CONVERSION\") of that profile.
    ...
    async createEventRaw(requestParameters: CreateEventRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters['interactionEventBean'] == null) {
            throw new runtime.RequiredError(
                'interactionEventBean',
                'Required parameter "interactionEventBean" was null or undefined when calling createEvent().'
            );
        }
        ...
        const response = await this.request({
            ...
            body: InteractionEventBeanToJSON(requestParameters['interactionEventBean']),
        }, initOverrides);
