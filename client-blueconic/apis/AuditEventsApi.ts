...
import {
    AuditEventsBeanFromJSON,
    AuditEventsBeanToJSON,
} from '../models/index.js';
...
export class AuditEventsApi extends runtime.BaseAPI {
     ...
     * Get audit events
     */
    async queryRaw(requestParameters: QueryRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AuditEventsBean>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => AuditEventsBeanFromJSON(jsonValue));
    }
     ...
     * Get audit events
     */
    async query(requestParameters: QueryRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<AuditEventsBean> {
