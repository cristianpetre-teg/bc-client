...
import {
    RecommendationRequestFromJSON,
    RecommendationRequestToJSON,
    RecommendationResponseFromJSON,
    RecommendationResponseToJSON,
} from '../models/index.js';

export interface GetRecommendationsPostJsonpAsyncRequest {
    storeId: string;
...
export class RecommendationsApi extends runtime.BaseAPI {
     ...
     */
    async getRecommendationsPostJsonpAsyncRaw(requestParameters: GetRecommendationsPostJsonpAsyncRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RecommendationResponse>> {
        if (requestParameters['storeId'] == null) {
            throw new runtime.RequiredError(
                'storeId',
                'Required parameter "storeId" was null or undefined when calling getRecommendationsPostJsonpAsync().'
            );
        }

        if (requestParameters['recommendationRequest'] == null) {
            throw new runtime.RequiredError(
                'recommendationRequest',
                'Required parameter "recommendationRequest" was null or undefined when calling getRecommendationsPostJsonpAsync().'
            );
        }
        ...
        if (requestParameters['frequencyCap'] != null) {
            queryParameters['frequencyCap'] = requestParameters['frequencyCap'];
        }

        if (requestParameters['imageWidth'] != null) {
            queryParameters['imageWidth'] = requestParameters['imageWidth'];
        }

        if (requestParameters['imageHeight'] != null) {
            queryParameters['imageHeight'] = requestParameters['imageHeight'];
        }

        if (requestParameters['manualViewCounting'] != null) {
            queryParameters['manualViewCounting'] = requestParameters['manualViewCounting'];
        }
        ...
        const response = await this.request({
            ...
            body: requestParameters['recommendationRequest']!.map(RecommendationRequestToJSON),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => RecommendationResponseFromJSON(jsonValue));
    }
     ...
     * Generate recommendations
     */
    async getRecommendationsPostJsonpAsync(requestParameters: GetRecommendationsPostJsonpAsyncRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RecommendationResponse> {
        const response = await this.getRecommendationsPostJsonpAsyncRaw(requestParameters, initOverrides);
