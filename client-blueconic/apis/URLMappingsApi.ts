...
export interface GetShortenedURLRequest {
    id: string;
}
 ...
 * 
 */
export class URLMappingsApi extends runtime.BaseAPI {

    /**
     * Create a new URL mapping (separate from an external tracker).
     * Create URL mapping
     */
    async createURLRaw(requestParameters: CreateURLRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Urlmapping>> {
        if (requestParameters['urlmapping'] == null) {
            throw new runtime.RequiredError(
                'urlmapping',
                'Required parameter "urlmapping" was null or undefined when calling createURL().'
            );
        }
        ...
        const response = await this.request({
            ...
            body: UrlmappingToJSON(requestParameters['urlmapping']),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => UrlmappingFromJSON(jsonValue));
    }
     ...
     * Create URL mapping
     */
    async createURL(requestParameters: CreateURLRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Urlmapping> {
     ...
     * Get URL mapping
     */
    async getShortenedURLRaw(requestParameters: GetShortenedURLRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Urlmapping>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
                'Required parameter "id" was null or undefined when calling getShortenedURL().'
            );
        }
        ...
        const response = await this.request({
            path: `/urlmappings/{id}`.replace(`{${"id"}}`, encodeURIComponent(String(requestParameters['id']))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
     ...
     * Get URL mapping
     */
    async getShortenedURL(requestParameters: GetShortenedURLRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Urlmapping> {
        const response = await this.getShortenedURLRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Update URL mapping
     */
    async updateShortenedURLRaw(requestParameters: UpdateShortenedURLRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Urlmapping>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
                'Required parameter "id" was null or undefined when calling updateShortenedURL().'
            );
        }
        ...
        if (requestParameters['urlmapping'] == null) {
            throw new runtime.RequiredError(
                'urlmapping',
                'Required parameter "urlmapping" was null or undefined when calling updateShortenedURL().'
            );
        }
     ...
     * Update URL mapping
     */
    async updateShortenedURL(requestParameters: UpdateShortenedURLRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Urlmapping> {
        const response = await this.updateShortenedURLRaw(requestParameters, initOverrides);
        return await response.value();
    }
