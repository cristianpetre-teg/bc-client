...
import {
    ...
    BulkInputEntryV2FromJSON,
    BulkInputEntryV2ToJSON,
...
export interface GetProfileAsyncRequest {
    profileId: string;
    expand?: Array<string>;
    properties?: string;
    profileProperty?: Array<string>;
    groupProperty?: Array<string>;
    eventTypeId?: Array<string>;
    eventProperty?: Array<string>;
    eventCount?: number;
    fromDate?: string;
    toDate?: string;
...
export interface UpdateProfileAsyncRequest {
    bulkInputEntryV2: Array<BulkInputEntryV2>;
    objectiveIds?: string;
}
...
export class ProfilesApi extends runtime.BaseAPI {
    ...
    /**
     * Search for BlueConic profiles based on a specific value for an indexed (unique) property. Multiple name/value pairs can be used to refine the search.
     * Search profiles
     */
    async get2Raw(requestParameters: Get2Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Profiles>> {
        if (requestParameters['property'] == null) {
            throw new runtime.RequiredError(
                'property',
                'Required parameter "property" was null or undefined when calling get2().'
            );
        }
        ...
        if (requestParameters['value'] == null) {
            throw new runtime.RequiredError(
                'value',
                'Required parameter "value" was null or undefined when calling get2().'
            );
        }
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ProfilesFromJSON(jsonValue));
    }
     ...
     * Search profiles
     */
    async get2(requestParameters: Get2Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Profiles> {
     ...
     * Get one profile
     */
    async getProfileAsyncRaw(requestParameters: GetProfileAsyncRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Profile>> {
        if (requestParameters['profileId'] == null) {
            throw new runtime.RequiredError(
                'profileId',
                'Required parameter "profileId" was null or undefined when calling getProfileAsync().'
            );
        }
        ...
        if (requestParameters['profileProperty'] != null) {
            queryParameters['profileProperty'] = requestParameters['profileProperty'];
        }

        if (requestParameters['groupProperty'] != null) {
            queryParameters['groupProperty'] = requestParameters['groupProperty'];
        }
        ...
        if (requestParameters['eventProperty'] != null) {
            queryParameters['eventProperty'] = requestParameters['eventProperty'];
        }

        if (requestParameters['eventCount'] != null) {
            queryParameters['eventCount'] = requestParameters['eventCount'];
        }
     ...
     * Get one profile
     */
    async getProfileAsync(requestParameters: GetProfileAsyncRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Profile> {
        const response = await this.getProfileAsyncRaw(requestParameters, initOverrides);
        return await response.value();
    }

    /**
     * Create, update, or delete one or more profiles in a single request. This is the recommended way of creating, updating and deleting profiles.
     * Create, update, or delete one or more profiles
     */
    async updateProfileAsyncRaw(requestParameters: UpdateProfileAsyncRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<BulkResultBean>>> {
        if (requestParameters['bulkInputEntryV2'] == null) {
            throw new runtime.RequiredError(
                'bulkInputEntryV2',
                'Required parameter "bulkInputEntryV2" was null or undefined when calling updateProfileAsync().'
            );
        }

        const queryParameters: any = {};

        if (requestParameters['objectiveIds'] != null) {
            queryParameters['objectiveIds'] = requestParameters['objectiveIds'];
        }
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: requestParameters['bulkInputEntryV2']!.map(BulkInputEntryV2ToJSON),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => jsonValue.map(BulkResultBeanFromJSON));
    }
     ...
     * Create, update, or delete one or more profiles
     */
    async updateProfileAsync(requestParameters: UpdateProfileAsyncRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<BulkResultBean>> {
        const response = await this.updateProfileAsyncRaw(requestParameters, initOverrides);
        return await response.value();
    }
