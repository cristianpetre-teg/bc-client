...
import {
    ChannelFromJSON,
    ChannelToJSON,
    ChannelsV2SchemaFromJSON,
    ChannelsV2SchemaToJSON,
} from '../models/index.js';
...
export class ChannelsApi extends runtime.BaseAPI {
     ...
     * Get all channels
     */
    async getAllRaw(requestParameters: GetAllRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ChannelsV2Schema>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ChannelsV2SchemaFromJSON(jsonValue));
    }
     ...
     * Get all channels
     */
    async getAll(requestParameters: GetAllRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ChannelsV2Schema> {
