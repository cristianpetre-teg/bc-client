...
import {
    ...
    SegmentProfilesFromJSON,
    SegmentProfilesToJSON,
    SegmentsFromJSON,
    SegmentsToJSON,
} from '../models/index.js';

export interface GetSegmentExportNormalRequest {
    segment: string;
    cursor?: string;
    count?: number;
    properties?: string;
...
export class SegmentsApi extends runtime.BaseAPI {
     ...
     */
    async getSegmentExportNormalRaw(requestParameters: GetSegmentExportNormalRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SegmentProfiles>> {
        if (requestParameters['segment'] == null) {
            throw new runtime.RequiredError(
                'segment',
                'Required parameter "segment" was null or undefined when calling getSegmentExportNormal().'
            );
        }
        ...
        const response = await this.request({
            path: `/segments/{segment}/profiles`.replace(`{${"segment"}}`, encodeURIComponent(String(requestParameters['segment']))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => SegmentProfilesFromJSON(jsonValue));
    }
     ...
     * Get profiles in segment
     */
    async getSegmentExportNormal(requestParameters: GetSegmentExportNormalRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<SegmentProfiles> {
        const response = await this.getSegmentExportNormalRaw(requestParameters, initOverrides);
     ...
     * Get all segments
     */
    async getSegmentsRaw(requestParameters: GetSegmentsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Segments>> {
        const queryParameters: any = {};
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => SegmentsFromJSON(jsonValue));
    }
     ...
     * Get all segments
     */
    async getSegments(requestParameters: GetSegmentsRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Segments> {
