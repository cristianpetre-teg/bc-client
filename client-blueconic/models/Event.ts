...
export interface Event {
    ...
    eventTypeId?: string;
    /**
     * An identifier to identify the event. Preferred to be unique, although it isn't required. If an event with the same ID is present on the profile's timeline, it will be overwritten. Note that the combination of ID, event type ID, and date uniquely identifies an event.
     * @type {string}
     * @memberof Event
     */
    id?: string;
    /**
     * An (external) identifier which can be passed along with a timeline event operation and is returned in the response.
     * @type {string}
     * @memberof Event
     */
    identifier?: string;
 ...
 * @export
 */
export const EventStrategyEnum = {
    Set: 'SET',
    Upsert: 'UPSERT',
    Update: 'UPDATE',
    Delete: 'DELETE'
} as const;
export type EventStrategyEnum = typeof EventStrategyEnum[keyof typeof EventStrategyEnum];
...
export function EventFromJSONTyped(json: any, ignoreDiscriminator: boolean): Event {
    ...
    return {
        ...
        'data': json['data'] == null ? undefined : ((json['data'] as Array<any>).map(PropertyFromJSON)),
...
export function EventToJSON(value?: Event | null): any {
    ...
    return {
        ...
        'data': value['data'] == null ? undefined : ((value['data'] as Array<any>).map(PropertyToJSON)),
