 ...
 */
export function instanceOfRecommendationRequest(value: object): boolean {
    if (!('boosts' in value)) return false;
    if (!('id' in value)) return false;
    return true;
}

export function RecommendationRequestFromJSON(json: any): RecommendationRequest {
    return RecommendationRequestFromJSONTyped(json, false);
}

export function RecommendationRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): RecommendationRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function RecommendationRequestToJSON(value?: RecommendationRequest | null): any {
    if (value == null) {
        return value;
    }
    return {
