...
import {
    RecommendationItemFromJSON,
    RecommendationItemFromJSONTyped,
    RecommendationItemToJSON,
} from './RecommendationItem.js';

/**
 * The recommendation blocks as defined in the request body.
 * @export
 * @interface RecommendationSubResponse
 */
export interface RecommendationSubResponse {
    /**
     * The ID for this recommendation block, as defined in the request body.
     * @type {string}
     * @memberof RecommendationSubResponse
     */
    id?: string;
    /**
     * The recommendations of this block.
...
/**
 * Check if a given object implements the RecommendationSubResponse interface.
 */
export function instanceOfRecommendationSubResponse(value: object): boolean {
    return true;
}

export function RecommendationSubResponseFromJSON(json: any): RecommendationSubResponse {
    return RecommendationSubResponseFromJSONTyped(json, false);
}

export function RecommendationSubResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): RecommendationSubResponse {
    if (json == null) {
        return json;
    }
    return {
        ...
        'recommendations': json['recommendations'] == null ? undefined : ((json['recommendations'] as Array<any>).map(RecommendationItemFromJSON)),
    };
}

export function RecommendationSubResponseToJSON(value?: RecommendationSubResponse | null): any {
    if (value == null) {
        return value;
    }
    return {
        ...
        'id': value['id'],
        'recommendations': value['recommendations'] == null ? undefined : ((value['recommendations'] as Array<any>).map(RecommendationItemToJSON)),
    };
}
