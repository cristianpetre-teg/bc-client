...
export interface Property {
    /**
     * Timeline event property ID to apply to this rule for.
     * @type {string}
     * @memberof Property
     */
    id?: string;
    /**
     * The strategy to apply to primitive timeline event properties. For nested timeline event properties, SET/UPSERT/UPDATE/DELETE are supported.
     * @type {string}
     * @memberof Property
     */
    strategy?: PropertyStrategyEnum;
    /**
     * The values for this timeline event property. Either a list of primitives (strings, numbers, booleans) or a list of objects (see example).
     * @type {Array<object>}
     * @memberof Property
     */
    values?: Array<object>;
 ...
 * @export
 */
export const PropertyStrategyEnum = {
    Add: 'ADD',
    Set: 'SET',
    SetIfEmpty: 'SET_IF_EMPTY'
} as const;
export type PropertyStrategyEnum = typeof PropertyStrategyEnum[keyof typeof PropertyStrategyEnum];
