...
/**
 * The rules that will be executed on this group.
 * @export
 * @interface BulkGroupInputEntryProperties
 */
export interface BulkGroupInputEntryProperties {
    /**
     * The profile property ID to apply to this rule for.
     * @type {string}
     * @memberof BulkGroupInputEntryProperties
     */
    id?: string;
    /**
     * The strategy to apply to this rule.
     * @type {string}
     * @memberof BulkGroupInputEntryProperties
     */
    strategy?: BulkGroupInputEntryPropertiesStrategyEnum;
    /**
     * The values to apply to this rule.
     * @type {Array<string>}
     * @memberof BulkGroupInputEntryProperties
     */
    values?: Array<string>;
 ...
 * @export
 */
export const BulkGroupInputEntryPropertiesStrategyEnum = {
    Add: 'ADD',
    Set: 'SET',
    SetIfEmpty: 'SET_IF_EMPTY',
    Increment: 'INCREMENT',
    Remove: 'REMOVE'
} as const;
export type BulkGroupInputEntryPropertiesStrategyEnum = typeof BulkGroupInputEntryPropertiesStrategyEnum[keyof typeof BulkGroupInputEntryPropertiesStrategyEnum];


/**
 * Check if a given object implements the BulkGroupInputEntryProperties interface.
 */
export function instanceOfBulkGroupInputEntryProperties(value: object): boolean {
    return true;
}

export function BulkGroupInputEntryPropertiesFromJSON(json: any): BulkGroupInputEntryProperties {
    return BulkGroupInputEntryPropertiesFromJSONTyped(json, false);
}

export function BulkGroupInputEntryPropertiesFromJSONTyped(json: any, ignoreDiscriminator: boolean): BulkGroupInputEntryProperties {
    if (json == null) {
        return json;
    }
    return {
...
export function BulkGroupInputEntryPropertiesToJSON(value?: BulkGroupInputEntryProperties | null): any {
    if (value == null) {
        return value;
    }
    return {
