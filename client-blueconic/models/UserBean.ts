...
/**
 * Check if a given object implements the UserBean interface.
 */
export function instanceOfUserBean(value: object): boolean {
    return true;
}

export function UserBeanFromJSON(json: any): UserBean {
    return UserBeanFromJSONTyped(json, false);
}

export function UserBeanFromJSONTyped(json: any, ignoreDiscriminator: boolean): UserBean {
    if (json == null) {
        return json;
    }
    return {
...
export function UserBeanToJSON(value?: UserBean | null): any {
    if (value == null) {
        return value;
    }
    return {
