...
import type { ProfileEvent } from './ProfileEvent.js';
import {
    ProfileEventFromJSON,
    ProfileEventFromJSONTyped,
    ProfileEventToJSON,
} from './ProfileEvent.js';
...
export interface ProfileEvents {
    /**
     * 
     * @type {Array<ProfileEvent>}
     * @memberof ProfileEvents
     */
...
/**
 * Check if a given object implements the ProfileEvents interface.
 */
export function instanceOfProfileEvents(value: object): boolean {
    return true;
}

export function ProfileEventsFromJSON(json: any): ProfileEvents {
    return ProfileEventsFromJSONTyped(json, false);
}

export function ProfileEventsFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProfileEvents {
    if (json == null) {
        return json;
    }
    return {
        
        'events': json['events'] == null ? undefined : ((json['events'] as Array<any>).map(ProfileEventFromJSON)),
...
export function ProfileEventsToJSON(value?: ProfileEvents | null): any {
    if (value == null) {
        return value;
    }
    return {
        
        'events': value['events'] == null ? undefined : ((value['events'] as Array<any>).map(ProfileEventToJSON)),
