...
export interface Boost {
     ...
     * @memberof Boost
     */
    algorithm: BoostAlgorithmEnum;
    /**
     * Ramp up value for algorithms that use it
     * @type {string}
     * @memberof Boost
     */
    rampUp?: BoostRampUpEnum;
    /**
     * Boost value can be a whole or half number: 1, 1.5, 2, 2.5, …, 9.5, 10.
     * @type {number}
     * @memberof Boost
     */
    value: number;
 ...
 * @export
 */
export const BoostAlgorithmEnum = {
    CollaborativeFiltering: 'COLLABORATIVE_FILTERING',
    Interest: 'INTEREST',
    LookAlike: 'LOOK_ALIKE',
    Recency: 'RECENCY',
    RecentCtr: 'RECENT_CTR',
    RecentEntrypage: 'RECENT_ENTRYPAGE',
    RecentView: 'RECENT_VIEW',
    RecentlyBought: 'RECENTLY_BOUGHT',
    RecentlyShoppingcart: 'RECENTLY_SHOPPINGCART',
    RecentlyViewed: 'RECENTLY_VIEWED',
    SameCategory: 'SAME_CATEGORY'
} as const;
export type BoostAlgorithmEnum = typeof BoostAlgorithmEnum[keyof typeof BoostAlgorithmEnum];

/**
 * @export
 */
export const BoostRampUpEnum = {
    Instant: 'INSTANT',
    VerySlow: 'VERY_SLOW',
    Slow: 'SLOW',
    Normal: 'NORMAL',
...
export type BoostRampUpEnum = typeof BoostRampUpEnum[keyof typeof BoostRampUpEnum];


/**
 * Check if a given object implements the Boost interface.
 */
export function instanceOfBoost(value: object): boolean {
...
export function BoostFromJSONTyped(json: any, ignoreDiscriminator: boolean): Boost {
    ...
    return {
        ...
        'rampUp': json['rampUp'] == null ? undefined : json['rampUp'],
        'value': json['value'],
    };
}

export function BoostToJSON(value?: Boost | null): any {
    if (value == null) {
        return value;
    }
    return {
