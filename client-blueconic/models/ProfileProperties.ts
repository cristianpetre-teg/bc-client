...
export interface ProfileProperties {
     ...
     * @memberof ProfileProperties
     */
    profileProperties?: Array<ProfileProperty>;
    /**
     * The start index.
     * @type {number}
     * @memberof ProfileProperties
...
/**
 * Check if a given object implements the ProfileProperties interface.
 */
export function instanceOfProfileProperties(value: object): boolean {
    return true;
}

export function ProfilePropertiesFromJSON(json: any): ProfileProperties {
    return ProfilePropertiesFromJSONTyped(json, false);
}

export function ProfilePropertiesFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProfileProperties {
    if (json == null) {
        return json;
    }
    return {
        ...
        'profileProperties': json['profileProperties'] == null ? undefined : ((json['profileProperties'] as Array<any>).map(ProfilePropertyFromJSON)),
...
export function ProfilePropertiesToJSON(value?: ProfileProperties | null): any {
    if (value == null) {
        return value;
    }
    return {
        ...
        'profileProperties': value['profileProperties'] == null ? undefined : ((value['profileProperties'] as Array<any>).map(ProfilePropertyToJSON)),
