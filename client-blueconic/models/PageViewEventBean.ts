 ...
 * 
 * @export
 * @interface PageViewEventBean
 */
export interface PageViewEventBean {
    /**
...
/**
 * Check if a given object implements the PageViewEventBean interface.
 */
export function instanceOfPageViewEventBean(value: object): boolean {
    if (!('url' in value)) return false;
    return true;
}

export function PageViewEventBeanFromJSON(json: any): PageViewEventBean {
    return PageViewEventBeanFromJSONTyped(json, false);
}

export function PageViewEventBeanFromJSONTyped(json: any, ignoreDiscriminator: boolean): PageViewEventBean {
    if (json == null) {
        return json;
    }
    return {
...
export function PageViewEventBeanToJSON(value?: PageViewEventBean | null): any {
    if (value == null) {
        return value;
    }
    return {
