...
import {
    LifecycleStageFromJSON,
    LifecycleStageFromJSONTyped,
    LifecycleStageToJSON,
} from './LifecycleStage.js';
import type { MatchingGroup } from './MatchingGroup.js';
import {
    MatchingGroupFromJSON,
    MatchingGroupFromJSONTyped,
    MatchingGroupToJSON,
} from './MatchingGroup.js';
...
import type { ProfileSegmentBean } from './ProfileSegmentBean.js';
import {
    ProfileSegmentBeanFromJSON,
    ProfileSegmentBeanFromJSONTyped,
    ProfileSegmentBeanToJSON,
} from './ProfileSegmentBean.js';
...
export interface Profile {
    ...
    id?: string;
    /**
     * The creation date of the object. Datetime in UTC in the https://www.ietf.org/rfc/rfc3339.txt format, example = "2023-01-22T11:21:33.872Z".
     * @type {Date}
     * @memberof Profile
     */
    creationDate?: Date;
     ...
     * @memberof Profile
     */
    privacyLegislation?: ProfilePrivacyLegislationEnum;
    /**
     * List of objective IDs that the profile has given consent to.
     * @type {Array<string>}
     * @memberof Profile
     */
    consentedObjectives?: Array<string>;
    /**
     * List of objective IDs that the profile has refused consent to.
     * @type {Array<string>}
     * @memberof Profile
     */
    refusedObjectives?: Array<string>;
    /**
     * 
     * @type {Permissions}
     * @memberof Profile
    ...
    groups?: Array<Group>;
    /**
     * Groups that the profile is a part of and match the segment refinements.
     * @type {Array<MatchingGroup>}
     * @memberof Profile
     */
    matchingGroups?: Array<MatchingGroup>;
    /**
     * Lifecycle stages that the profile is part of.
     * @type {Array<LifecycleStage>}
     * @memberof Profile
     */
    lifecycleStages?: Array<LifecycleStage>;
    /**
     * The profile ID that replaced this profile.
     * @type {string}
     * @memberof Profile
     */
    replacedBy?: string;
    /**
     * The IDs of the profiles that are replaced by this profile.
     * @type {Array<string>}
     * @memberof Profile
     */
    ...
    /**
     * 
     * @type {Array<ProfileSegmentBean>}
     * @memberof Profile
     */
    segments?: Array<ProfileSegmentBean>;
}
 ...
 * @export
 */
export const ProfilePrivacyLegislationEnum = {
    None: 'NONE',
    Gdpr: 'GDPR',
    Pipeda: 'PIPEDA',
    Ccpa: 'CCPA',
...
export type ProfilePrivacyLegislationEnum = typeof ProfilePrivacyLegislationEnum[keyof typeof ProfilePrivacyLegislationEnum];
...
export function ProfileFromJSONTyped(json: any, ignoreDiscriminator: boolean): Profile {
    ...
    return {
        ...
        'consentedObjectives': json['consentedObjectives'] == null ? undefined : json['consentedObjectives'],
        'refusedObjectives': json['refusedObjectives'] == null ? undefined : json['refusedObjectives'],
        ...
        'matchingGroups': json['matchingGroups'] == null ? undefined : ((json['matchingGroups'] as Array<any>).map(MatchingGroupFromJSON)),
        'lifecycleStages': json['lifecycleStages'] == null ? undefined : ((json['lifecycleStages'] as Array<any>).map(LifecycleStageFromJSON)),
        'replacedBy': json['replacedBy'] == null ? undefined : json['replacedBy'],
        'replaces': json['replaces'] == null ? undefined : json['replaces'],
        'segments': json['segments'] == null ? undefined : ((json['segments'] as Array<any>).map(ProfileSegmentBeanFromJSON)),
    };
}
...
export function ProfileToJSON(value?: Profile | null): any {
    ...
    return {
        ...
        'consentedObjectives': value['consentedObjectives'],
        'refusedObjectives': value['refusedObjectives'],
        ...
        'matchingGroups': value['matchingGroups'] == null ? undefined : ((value['matchingGroups'] as Array<any>).map(MatchingGroupToJSON)),
        'lifecycleStages': value['lifecycleStages'] == null ? undefined : ((value['lifecycleStages'] as Array<any>).map(LifecycleStageToJSON)),
        'replacedBy': value['replacedBy'],
        'replaces': value['replaces'],
        'segments': value['segments'] == null ? undefined : ((value['segments'] as Array<any>).map(ProfileSegmentBeanToJSON)),
    };
}
