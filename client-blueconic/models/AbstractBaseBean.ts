 ...
 * @export
 * @interface AbstractBaseBean
 */
export interface AbstractBaseBean {
    /**
     * The unique identifier for the object.
     * @type {string}
     * @memberof AbstractBaseBean
     */
    id?: string;
}

/**
 * Check if a given object implements the AbstractBaseBean interface.
 */
export function instanceOfAbstractBaseBean(value: object): boolean {
    return true;
}

export function AbstractBaseBeanFromJSON(json: any): AbstractBaseBean {
    return AbstractBaseBeanFromJSONTyped(json, false);
}

export function AbstractBaseBeanFromJSONTyped(json: any, ignoreDiscriminator: boolean): AbstractBaseBean {
    if (json == null) {
        return json;
    }
    return {
...
export function AbstractBaseBeanToJSON(value?: AbstractBaseBean | null): any {
    if (value == null) {
        return value;
    }
    return {
