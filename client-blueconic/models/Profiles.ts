...
import type { AbstractBaseBean } from './AbstractBaseBean.js';
import {
    AbstractBaseBeanFromJSON,
    AbstractBaseBeanFromJSONTyped,
    AbstractBaseBeanToJSON,
} from './AbstractBaseBean.js';
...
export interface Profiles {
    ...
    itemsPerPage?: number;
    /**
     * List of profile IDs that matches search criteria.
     * @type {Array<AbstractBaseBean>}
     * @memberof Profiles
     */
    profiles?: Array<AbstractBaseBean>;
    /**
     * The start index.
     * @type {number}
     * @memberof Profiles
...
/**
 * Check if a given object implements the Profiles interface.
 */
export function instanceOfProfiles(value: object): boolean {
    return true;
}

export function ProfilesFromJSON(json: any): Profiles {
    return ProfilesFromJSONTyped(json, false);
}

export function ProfilesFromJSONTyped(json: any, ignoreDiscriminator: boolean): Profiles {
    if (json == null) {
        return json;
    }
    return {
        ...
        'profiles': json['profiles'] == null ? undefined : ((json['profiles'] as Array<any>).map(AbstractBaseBeanFromJSON)),
...
export function ProfilesToJSON(value?: Profiles | null): any {
    if (value == null) {
        return value;
    }
    return {
        ...
        'profiles': value['profiles'] == null ? undefined : ((value['profiles'] as Array<any>).map(AbstractBaseBeanToJSON)),
