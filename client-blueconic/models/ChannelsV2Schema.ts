...
import type { ChannelBeanV2SchemaForChannelsV2 } from './ChannelBeanV2SchemaForChannelsV2.js';
import {
    ChannelBeanV2SchemaForChannelsV2FromJSON,
    ChannelBeanV2SchemaForChannelsV2FromJSONTyped,
    ChannelBeanV2SchemaForChannelsV2ToJSON,
} from './ChannelBeanV2SchemaForChannelsV2.js';

/**
 * 
 * @export
 * @interface ChannelsV2Schema
 */
export interface ChannelsV2Schema {
    /**
     * The channels.
     * @type {Array<ChannelBeanV2SchemaForChannelsV2>}
     * @memberof ChannelsV2Schema
     */
    channels?: Array<ChannelBeanV2SchemaForChannelsV2>;
    /**
...
/**
 * Check if a given object implements the ChannelsV2Schema interface.
 */
export function instanceOfChannelsV2Schema(value: object): boolean {
    return true;
}

export function ChannelsV2SchemaFromJSON(json: any): ChannelsV2Schema {
    return ChannelsV2SchemaFromJSONTyped(json, false);
}

export function ChannelsV2SchemaFromJSONTyped(json: any, ignoreDiscriminator: boolean): ChannelsV2Schema {
    if (json == null) {
        return json;
    }
    return {
        
        'channels': json['channels'] == null ? undefined : ((json['channels'] as Array<any>).map(ChannelBeanV2SchemaForChannelsV2FromJSON)),
...
export function ChannelsV2SchemaToJSON(value?: ChannelsV2Schema | null): any {
    if (value == null) {
        return value;
    }
    return {
        
        'channels': value['channels'] == null ? undefined : ((value['channels'] as Array<any>).map(ChannelBeanV2SchemaForChannelsV2ToJSON)),
