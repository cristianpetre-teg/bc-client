...
export interface Urlmapping {
    ...
    id: string;
    /**
     * List of profile properties to be set.
     * @type {Array<Property>}
     * @memberof Urlmapping
     */
    properties: Array<Property>;
    /**
     * The tracker must be one of the available types.
     * @type {string}
     * @memberof Urlmapping
     */
    type?: UrlmappingTypeEnum;
    /**
     * The full URL of the target page (only applicable for type SHORTENEDURL).
     * @type {string}
     * @memberof Urlmapping
     */
    url: string;
 ...
 * @export
 */
export const UrlmappingTypeEnum = {
    Trackingpixel: 'TRACKINGPIXEL',
    Shortenedurl: 'SHORTENEDURL'
} as const;
export type UrlmappingTypeEnum = typeof UrlmappingTypeEnum[keyof typeof UrlmappingTypeEnum];


/**
 * Check if a given object implements the Urlmapping interface.
 */
export function instanceOfUrlmapping(value: object): boolean {
...
export function UrlmappingFromJSON(json: any): Urlmapping {
    return UrlmappingFromJSONTyped(json, false);
}

export function UrlmappingFromJSONTyped(json: any, ignoreDiscriminator: boolean): Urlmapping {
    if (json == null) {
        return json;
    }
    return {
        ...
        'id': json['id'],
        'properties': ((json['properties'] as Array<any>).map(PropertyFromJSON)),
        'type': json['type'] == null ? undefined : json['type'],
        'url': json['url'],
    };
}

export function UrlmappingToJSON(value?: Urlmapping | null): any {
    if (value == null) {
        return value;
    }
    return {
        ...
        'id': value['id'],
        'properties': ((value['properties'] as Array<any>).map(PropertyToJSON)),
        'type': value['type'],
        'url': value['url'],
    };
}
