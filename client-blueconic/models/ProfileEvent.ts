 ...
 * @export
 */
export const ProfileEventTypeEnum = {
    PermissionLevelChanged: 'PermissionLevelChanged',
    ConsentChanged: 'ConsentChanged'
} as const;
export type ProfileEventTypeEnum = typeof ProfileEventTypeEnum[keyof typeof ProfileEventTypeEnum];


/**
 * Check if a given object implements the ProfileEvent interface.
 */
export function instanceOfProfileEvent(value: object): boolean {
    return true;
}

export function ProfileEventFromJSON(json: any): ProfileEvent {
    return ProfileEventFromJSONTyped(json, false);
}

export function ProfileEventFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProfileEvent {
    if (json == null) {
        return json;
    }
    return {
        ...
        'property': json['property'] == null ? undefined : ((json['property'] as Array<any>).map(PropertyFromJSON)),
        'type': json['type'] == null ? undefined : json['type'],
    };
}

export function ProfileEventToJSON(value?: ProfileEvent | null): any {
    if (value == null) {
        return value;
    }
    return {
        ...
        'date': value['date'],
        'property': value['property'] == null ? undefined : ((value['property'] as Array<any>).map(PropertyToJSON)),
        'type': value['type'],
    };
}
