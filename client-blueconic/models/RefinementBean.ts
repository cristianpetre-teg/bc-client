 ...
 * 
 * @export
 * @interface RefinementBean
 */
export interface RefinementBean {
    /**
     * The days count
     * @type {number}
     * @memberof RefinementBean
     */
    daysCount?: number;
    /**
     * 
     * @type {Array<RefinementBean>}
     * @memberof RefinementBean
     */
    filters?: Array<RefinementBean>;
    /**
     * The from date in ISO 8601 format (e.g. '2023-01-22T11:21:33.872Z')
     * @type {string}
     * @memberof RefinementBean
     */
    fromDate?: string;
    ...
    property?: string;
    /**
     * The to date in ISO 8601 format (e.g. '2023-01-22T11:21:33.872Z')
     * @type {string}
     * @memberof RefinementBean
     */
    toDate?: string;
...
/**
 * Check if a given object implements the RefinementBean interface.
 */
export function instanceOfRefinementBean(value: object): boolean {
    return true;
}

export function RefinementBeanFromJSON(json: any): RefinementBean {
    return RefinementBeanFromJSONTyped(json, false);
}

export function RefinementBeanFromJSONTyped(json: any, ignoreDiscriminator: boolean): RefinementBean {
    if (json == null) {
        return json;
    }
    return {
        ...
        'filters': json['filters'] == null ? undefined : ((json['filters'] as Array<any>).map(RefinementBeanFromJSON)),
        'fromDate': json['fromDate'] == null ? undefined : json['fromDate'],
        'fromValue': json['fromValue'] == null ? undefined : json['fromValue'],
        'groupProperty': json['groupProperty'] == null ? undefined : json['groupProperty'],
        'hoursCount': json['hoursCount'] == null ? undefined : json['hoursCount'],
        ...
        'toValue': json['toValue'] == null ? undefined : json['toValue'],
        'values': json['values'] == null ? undefined : json['values'],
    };
}

export function RefinementBeanToJSON(value?: RefinementBean | null): any {
    if (value == null) {
        return value;
    }
    return {
        ...
        'filters': value['filters'] == null ? undefined : ((value['filters'] as Array<any>).map(RefinementBeanToJSON)),
