...
/**
 * Check if a given object implements the Segments interface.
 */
export function instanceOfSegments(value: object): boolean {
    return true;
}

export function SegmentsFromJSON(json: any): Segments {
    return SegmentsFromJSONTyped(json, false);
}

export function SegmentsFromJSONTyped(json: any, ignoreDiscriminator: boolean): Segments {
    if (json == null) {
        return json;
    }
    return {
        ...
        'segments': json['segments'] == null ? undefined : ((json['segments'] as Array<any>).map(SegmentFromJSON)),
...
export function SegmentsToJSON(value?: Segments | null): any {
    if (value == null) {
        return value;
    }
    return {
        ...
        'segments': value['segments'] == null ? undefined : ((value['segments'] as Array<any>).map(SegmentToJSON)),
