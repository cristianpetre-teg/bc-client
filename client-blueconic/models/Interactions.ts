 ...
 */
export function instanceOfInteractions(value: object): boolean {
    return true;
}
...
export function InteractionsFromJSONTyped(json: any, ignoreDiscriminator: boolean): Interactions {
    ...
    return {
        ...
        'interactions': json['interactions'] == null ? undefined : ((json['interactions'] as Array<any>).map(EntryFromJSON)),
    };
}

export function InteractionsToJSON(value?: Interactions | null): any {
    if (value == null) {
        return value;
    }
    return {
        
        'interactions': value['interactions'] == null ? undefined : ((value['interactions'] as Array<any>).map(EntryToJSON)),
    };
}
