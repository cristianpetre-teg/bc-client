 ...
 * 
 * @export
 * @interface GroupsAPIGroups
 */
export interface GroupsAPIGroups {
    /**
...
/**
 * Check if a given object implements the GroupsAPIGroups interface.
 */
export function instanceOfGroupsAPIGroups(value: object): boolean {
    return true;
}

export function GroupsAPIGroupsFromJSON(json: any): GroupsAPIGroups {
    return GroupsAPIGroupsFromJSONTyped(json, false);
}

export function GroupsAPIGroupsFromJSONTyped(json: any, ignoreDiscriminator: boolean): GroupsAPIGroups {
    if (json == null) {
        return json;
    }
    return {
...
export function GroupsAPIGroupsToJSON(value?: GroupsAPIGroups | null): any {
    if (value == null) {
        return value;
    }
    return {
