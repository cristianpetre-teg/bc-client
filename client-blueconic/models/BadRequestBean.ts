...
import type { ErrorBean } from './ErrorBean.js';
import {
    ErrorBeanFromJSON,
    ErrorBeanFromJSONTyped,
    ErrorBeanToJSON,
} from './ErrorBean.js';
 ...
 * 
 * @export
 * @interface BadRequestBean
 */
export interface BadRequestBean {
    /**
     * 
     * @type {number}
     * @memberof BadRequestBean
     */
    code?: number;
    /**
     * 
     * @type {Array<ErrorBean>}
     * @memberof BadRequestBean
     */
    errors?: Array<ErrorBean>;
    /**
     * 
     * @type {string}
     * @memberof BadRequestBean
...
/**
 * Check if a given object implements the BadRequestBean interface.
 */
export function instanceOfBadRequestBean(value: object): boolean {
    return true;
}

export function BadRequestBeanFromJSON(json: any): BadRequestBean {
    return BadRequestBeanFromJSONTyped(json, false);
}

export function BadRequestBeanFromJSONTyped(json: any, ignoreDiscriminator: boolean): BadRequestBean {
    if (json == null) {
        return json;
    }
    return {
        ...
        'errors': json['errors'] == null ? undefined : ((json['errors'] as Array<any>).map(ErrorBeanFromJSON)),
        'message': json['message'] == null ? undefined : json['message'],
    };
}

export function BadRequestBeanToJSON(value?: BadRequestBean | null): any {
    if (value == null) {
        return value;
    }
    return {
        ...
        'code': value['code'],
        'errors': value['errors'] == null ? undefined : ((value['errors'] as Array<any>).map(ErrorBeanToJSON)),
