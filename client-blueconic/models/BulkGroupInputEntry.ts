...
import type { BulkGroupInputEntryProperties } from './BulkGroupInputEntryProperties.js';
import {
    BulkGroupInputEntryPropertiesFromJSON,
    BulkGroupInputEntryPropertiesFromJSONTyped,
    BulkGroupInputEntryPropertiesToJSON,
} from './BulkGroupInputEntryProperties.js';

/**
 * 
 * @export
 * @interface BulkGroupInputEntry
 */
export interface BulkGroupInputEntry {
    /**
     * Specifies the domain group in which a group is created. Used for matching and creating groups.
     * @type {string}
     * @memberof BulkGroupInputEntry
     */
    domainGroup?: string;
    /**
     * The BlueConic group ID to search for.
     * @type {string}
     * @memberof BulkGroupInputEntry
     */
    groupId?: string;
    /**
     * The BlueConic group type ID.
     * @type {string}
     * @memberof BulkGroupInputEntry
     */
    groupTypeId?: string;
    ...
    /**
     * 
     * @type {BulkGroupInputEntryProperties}
     * @memberof BulkGroupInputEntry
     */
    properties?: BulkGroupInputEntryProperties;
    /**
     * The strategy to apply to the given entry. Can be used to create, update or delete groups.
     * @type {string}
     * @memberof BulkGroupInputEntry
     */
    strategy?: BulkGroupInputEntryStrategyEnum;
}
 ...
 * @export
 */
export const BulkGroupInputEntryStrategyEnum = {
    Upsert: 'UPSERT',
    Update: 'UPDATE',
    Delete: 'DELETE'
} as const;
export type BulkGroupInputEntryStrategyEnum = typeof BulkGroupInputEntryStrategyEnum[keyof typeof BulkGroupInputEntryStrategyEnum];


/**
 * Check if a given object implements the BulkGroupInputEntry interface.
 */
export function instanceOfBulkGroupInputEntry(value: object): boolean {
    return true;
}

export function BulkGroupInputEntryFromJSON(json: any): BulkGroupInputEntry {
    return BulkGroupInputEntryFromJSONTyped(json, false);
}

export function BulkGroupInputEntryFromJSONTyped(json: any, ignoreDiscriminator: boolean): BulkGroupInputEntry {
    if (json == null) {
        return json;
    }
    return {
        ...
        'properties': json['properties'] == null ? undefined : BulkGroupInputEntryPropertiesFromJSON(json['properties']),
        'strategy': json['strategy'] == null ? undefined : json['strategy'],
    };
}

export function BulkGroupInputEntryToJSON(value?: BulkGroupInputEntry | null): any {
    if (value == null) {
        return value;
    }
    return {
        ...
        'properties': BulkGroupInputEntryPropertiesToJSON(value['properties']),
