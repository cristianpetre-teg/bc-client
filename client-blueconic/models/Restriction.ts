...
export interface Restriction {
    /**
     * The segment ID this profile should be a part of.
     * @type {string}
     * @memberof Restriction
     */
    isMemberOfSegment?: string;
}
...
export function RestrictionFromJSONTyped(json: any, ignoreDiscriminator: boolean): Restriction {
    ...
    return {
        ...
        'isMemberOfSegment': json['isMemberOfSegment'] == null ? undefined : json['isMemberOfSegment'],
    };
}
...
export function RestrictionToJSON(value?: Restriction | null): any {
    ...
    return {
        ...
        'isMemberOfSegment': value['isMemberOfSegment'],
    };
}
