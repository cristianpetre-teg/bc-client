...
export interface Criterium {
    /**
     * The profile property ID to match on.
     * @type {string}
     * @memberof Criterium
     */
    id?: string;
    /**
     * The profile property value to match on.
     * @type {string}
     * @memberof Criterium
     */
    value?: string;
...
/**
 * Check if a given object implements the Criterium interface.
 */
export function instanceOfCriterium(value: object): boolean {
    return true;
}

export function CriteriumFromJSON(json: any): Criterium {
    return CriteriumFromJSONTyped(json, false);
}

export function CriteriumFromJSONTyped(json: any, ignoreDiscriminator: boolean): Criterium {
    if (json == null) {
        return json;
    }
    return {
...
export function CriteriumToJSON(value?: Criterium | null): any {
    if (value == null) {
        return value;
    }
    return {
