...
export interface MatchingGroup {
    /**
     * The ID of the BlueConic profile property.
     * @type {string}
...
/**
 * Check if a given object implements the MatchingGroup interface.
 */
export function instanceOfMatchingGroup(value: object): boolean {
    return true;
}

export function MatchingGroupFromJSON(json: any): MatchingGroup {
    return MatchingGroupFromJSONTyped(json, false);
}

export function MatchingGroupFromJSONTyped(json: any, ignoreDiscriminator: boolean): MatchingGroup {
    if (json == null) {
        return json;
    }
    return {
        
        'profilePropertyId': json['profilePropertyId'] == null ? undefined : json['profilePropertyId'],
        'groupIds': json['groupIds'] == null ? undefined : json['groupIds'],
    };
}

export function MatchingGroupToJSON(value?: MatchingGroup | null): any {
    if (value == null) {
        return value;
    }
    return {
        
        'profilePropertyId': value['profilePropertyId'],
