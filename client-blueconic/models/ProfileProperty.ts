...
export interface ProfileProperty {
     ...
     * @type {string}
     * @memberof ProfileProperty
     */
    id?: string;
    /**
     * The restriction to apply to this rule.
     * @type {string}
     * @memberof ProfileProperty
     */
    restriction?: ProfilePropertyRestrictionEnum;
    /**
     * The strategy to apply to this rule.
     * @type {string}
     * @memberof ProfileProperty
     */
    strategy?: ProfilePropertyStrategyEnum;
    /**
 ...
 * @export
 */
export const ProfilePropertyRestrictionEnum = {
    AllProfiles: 'ALL_PROFILES',
    ExistingProfilesOnly: 'EXISTING_PROFILES_ONLY',
    NewProfilesOnly: 'NEW_PROFILES_ONLY'
} as const;
export type ProfilePropertyRestrictionEnum = typeof ProfilePropertyRestrictionEnum[keyof typeof ProfilePropertyRestrictionEnum];

/**
 * @export
 */
export const ProfilePropertyStrategyEnum = {
    Add: 'ADD',
    Set: 'SET',
...
export type ProfilePropertyStrategyEnum = typeof ProfilePropertyStrategyEnum[keyof typeof ProfilePropertyStrategyEnum];


/**
 * Check if a given object implements the ProfileProperty interface.
 */
export function instanceOfProfileProperty(value: object): boolean {
    return true;
}

export function ProfilePropertyFromJSON(json: any): ProfileProperty {
    return ProfilePropertyFromJSONTyped(json, false);
}

export function ProfilePropertyFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProfileProperty {
    if (json == null) {
        return json;
    }
    return {
...
export function ProfilePropertyToJSON(value?: ProfileProperty | null): any {
    if (value == null) {
        return value;
    }
    return {
