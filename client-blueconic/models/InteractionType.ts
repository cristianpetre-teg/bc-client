...
/**
 * Check if a given object implements the InteractionType interface.
 */
export function instanceOfInteractionType(value: object): boolean {
    return true;
}

export function InteractionTypeFromJSON(json: any): InteractionType {
    return InteractionTypeFromJSONTyped(json, false);
}

export function InteractionTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): InteractionType {
    if (json == null) {
        return json;
    }
    return {
        ...
        'positionType': json['positionType'] == null ? undefined : json['positionType'],
        'type': json['type'] == null ? undefined : json['type'],
    };
}

export function InteractionTypeToJSON(value?: InteractionType | null): any {
    if (value == null) {
        return value;
    }
    return {
