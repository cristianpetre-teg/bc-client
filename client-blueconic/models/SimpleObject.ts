...
/**
 * Check if a given object implements the SimpleObject interface.
 */
export function instanceOfSimpleObject(value: object): boolean {
    return true;
}

export function SimpleObjectFromJSON(json: any): SimpleObject {
    return SimpleObjectFromJSONTyped(json, false);
}

export function SimpleObjectFromJSONTyped(json: any, ignoreDiscriminator: boolean): SimpleObject {
    if (json == null) {
        return json;
    }
    return {
...
export function SimpleObjectToJSON(value?: SimpleObject | null): any {
    if (value == null) {
        return value;
    }
    return {
