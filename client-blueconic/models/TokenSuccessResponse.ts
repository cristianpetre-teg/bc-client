...
export interface TokenSuccessResponse {
    /**
     * The access token that gives access to the public API.
     * @type {string}
    ...
    expiresIn?: number;
    /**
     * The refresh token with which a new access and refresh token can be obtained.
     * @type {string}
     * @memberof TokenSuccessResponse
     */
    refreshToken?: string;
    /**
     * The token type of the access and refresh token.
     * @type {string}
     * @memberof TokenSuccessResponse
     */
    tokenType?: string;
