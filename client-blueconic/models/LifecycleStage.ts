...
import type { SimpleObject } from './SimpleObject.js';
import {
    SimpleObjectFromJSON,
    SimpleObjectFromJSONTyped,
    SimpleObjectToJSON,
...
export interface LifecycleStage {
     ...
     * 
     * @type {SimpleObject}
     * @memberof LifecycleStage
     */
    lifecycle?: SimpleObject;
    /**
     * 
     * @type {SimpleObject}
     * @memberof LifecycleStage
...
/**
 * Check if a given object implements the LifecycleStage interface.
 */
export function instanceOfLifecycleStage(value: object): boolean {
    return true;
}

export function LifecycleStageFromJSON(json: any): LifecycleStage {
    return LifecycleStageFromJSONTyped(json, false);
}

export function LifecycleStageFromJSONTyped(json: any, ignoreDiscriminator: boolean): LifecycleStage {
    if (json == null) {
        return json;
    }
    return {
        
        'lifecycle': json['lifecycle'] == null ? undefined : SimpleObjectFromJSON(json['lifecycle']),
        'stage': json['stage'] == null ? undefined : SimpleObjectFromJSON(json['stage']),
    };
}

export function LifecycleStageToJSON(value?: LifecycleStage | null): any {
    if (value == null) {
        return value;
    }
    return {
        
        'lifecycle': SimpleObjectToJSON(value['lifecycle']),
        'stage': SimpleObjectToJSON(value['stage']),
    };
}
