...
export interface Channel {
    ...
    id?: string;
    /**
     * The last modified date of the object. Datetime in UTC in the https://www.ietf.org/rfc/rfc3339.txt format, example = "2023-01-22T11:21:33.872Z".
     * @type {Date}
     * @memberof Channel
     */
...
export function ChannelFromJSONTyped(json: any, ignoreDiscriminator: boolean): Channel {
    ...
    return {
        ...
        'creator': json['creator'] == null ? undefined : UserBeanFromJSON(json['creator']),
        'description': json['description'] == null ? undefined : json['description'],
        'domain': json['domain'] == null ? undefined : SimpleDomainFromJSON(json['domain']),
        'hostname': json['hostname'] == null ? undefined : json['hostname'],
        'id': json['id'] == null ? undefined : json['id'],
        'lastModifiedDate': json['lastModifiedDate'] == null ? undefined : (new Date(json['lastModifiedDate'])),
        'lastModifiedUser': json['lastModifiedUser'] == null ? undefined : UserBeanFromJSON(json['lastModifiedUser']),
...
export function ChannelToJSON(value?: Channel | null): any {
    ...
    return {
        ...
        'creator': UserBeanToJSON(value['creator']),
        'description': value['description'],
        'domain': SimpleDomainToJSON(value['domain']),
        'hostname': value['hostname'],
        'id': value['id'],
        'lastModifiedUser': UserBeanToJSON(value['lastModifiedUser']),
        'logo': value['logo'],
        'name': value['name'],
        'tags': value['tags'],
        'type': value['type'],
