...
export interface RecommendationItem {
    ...
    score?: number;
    /**
     * The recommendation tracking url.
     * @type {string}
     * @memberof RecommendationItem
     */
    trackingUrl?: string;
...
/**
 * Check if a given object implements the RecommendationItem interface.
 */
export function instanceOfRecommendationItem(value: object): boolean {
    return true;
}

export function RecommendationItemFromJSON(json: any): RecommendationItem {
    return RecommendationItemFromJSONTyped(json, false);
}

export function RecommendationItemFromJSONTyped(json: any, ignoreDiscriminator: boolean): RecommendationItem {
    if (json == null) {
        return json;
    }
    return {
...
export function RecommendationItemToJSON(value?: RecommendationItem | null): any {
    if (value == null) {
        return value;
    }
    return {
