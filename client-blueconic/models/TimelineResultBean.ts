 ...
 * @export
 * @interface TimelineResultBean
 */
export interface TimelineResultBean {
    /**
     * The ID for this event.
     * @type {string}
     * @memberof TimelineResultBean
     */
    id?: string;
    /**
    ...
    identifier?: string;
    /**
     * The possible states for timeline events.
     * @type {string}
     * @memberof TimelineResultBean
     */
    state?: TimelineResultBeanStateEnum;
    /**
     * The errors found for the given timeline event changes (if any).
     * @type {Array<string>}
     * @memberof TimelineResultBean
     */
 ...
 * @export
 */
export const TimelineResultBeanStateEnum = {
    Created: 'CREATED',
    Set: 'SET',
    Modified: 'MODIFIED',
    Rejected: 'REJECTED',
...
export type TimelineResultBeanStateEnum = typeof TimelineResultBeanStateEnum[keyof typeof TimelineResultBeanStateEnum];


/**
 * Check if a given object implements the TimelineResultBean interface.
 */
export function instanceOfTimelineResultBean(value: object): boolean {
    return true;
}

export function TimelineResultBeanFromJSON(json: any): TimelineResultBean {
    return TimelineResultBeanFromJSONTyped(json, false);
}

export function TimelineResultBeanFromJSONTyped(json: any, ignoreDiscriminator: boolean): TimelineResultBean {
    if (json == null) {
        return json;
    }
    return {
...
export function TimelineResultBeanToJSON(value?: TimelineResultBean | null): any {
    if (value == null) {
        return value;
    }
    return {
