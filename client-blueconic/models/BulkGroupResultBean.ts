 ...
 * 
 * @export
 * @interface BulkGroupResultBean
 */
export interface BulkGroupResultBean {
    /**
     * 
     * @type {string}
     * @memberof BulkGroupResultBean
     */
    groupId?: string;
    /**
     * 
    ...
    identifier?: string;
    /**
     * The possible states for group related changes.
     * @type {string}
     * @memberof BulkGroupResultBean
     */
    state?: BulkGroupResultBeanStateEnum;
    /**
     * The errors found for the given group changes (if any).
     * @type {{ [key: string]: any; }}
     * @memberof BulkGroupResultBean
     */
 ...
 * @export
 */
export const BulkGroupResultBeanStateEnum = {
    Created: 'CREATED',
    Skipped: 'SKIPPED',
    Modified: 'MODIFIED',
    Unchanged: 'UNCHANGED',
    Notfound: 'NOTFOUND',
    Deleted: 'DELETED',
    UnknownGroupType: 'UNKNOWN_GROUP_TYPE'
} as const;
export type BulkGroupResultBeanStateEnum = typeof BulkGroupResultBeanStateEnum[keyof typeof BulkGroupResultBeanStateEnum];


/**
 * Check if a given object implements the BulkGroupResultBean interface.
 */
export function instanceOfBulkGroupResultBean(value: object): boolean {
    return true;
}

export function BulkGroupResultBeanFromJSON(json: any): BulkGroupResultBean {
    return BulkGroupResultBeanFromJSONTyped(json, false);
}

export function BulkGroupResultBeanFromJSONTyped(json: any, ignoreDiscriminator: boolean): BulkGroupResultBean {
    if (json == null) {
        return json;
    }
    return {
...
export function BulkGroupResultBeanToJSON(value?: BulkGroupResultBean | null): any {
    if (value == null) {
        return value;
    }
    return {
