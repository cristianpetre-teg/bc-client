 ...
 * 
 * @export
 * @interface SegmentProfiles
 */
export interface SegmentProfiles {
    /**
     * The cursor of the current page. `*` when not passed.
     * @type {string}
     * @memberof SegmentProfiles
     */
    cursor?: string;
    /**
    ...
    itemsPerPage?: number;
    /**
     * The links to the first and next/last page.
     * @type {Array<Link>}
     * @memberof SegmentProfiles
     */
    links?: Array<Link>;
...
/**
 * Check if a given object implements the SegmentProfiles interface.
 */
export function instanceOfSegmentProfiles(value: object): boolean {
    return true;
}

export function SegmentProfilesFromJSON(json: any): SegmentProfiles {
    return SegmentProfilesFromJSONTyped(json, false);
}

export function SegmentProfilesFromJSONTyped(json: any, ignoreDiscriminator: boolean): SegmentProfiles {
    if (json == null) {
        return json;
    }
    return {
        ...
        'profiles': json['profiles'] == null ? undefined : ((json['profiles'] as Array<any>).map(ProfileFromJSON)),
        'totalPages': json['totalPages'] == null ? undefined : json['totalPages'],
        'totalResults': json['totalResults'] == null ? undefined : json['totalResults'],
    };
}

export function SegmentProfilesToJSON(value?: SegmentProfiles | null): any {
    if (value == null) {
        return value;
    }
    return {
        ...
        'profiles': value['profiles'] == null ? undefined : ((value['profiles'] as Array<any>).map(ProfileToJSON)),
