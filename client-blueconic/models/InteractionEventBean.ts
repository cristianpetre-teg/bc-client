 ...
 * 
 * @export
 * @interface InteractionEventBean
 */
export interface InteractionEventBean {
    /**
     * The ID of the interaction. For example the ID of a dialogue variant.
     * @type {string}
     * @memberof InteractionEventBean
     */
    interactionId: string;
    /**
     * The ID of a BlueConic profile.
     * @type {string}
     * @memberof InteractionEventBean
     */
    profileId?: string;
     ...
     * @memberof InteractionEventBean
     */
    type: InteractionEventBeanTypeEnum;
    /**
 ...
 * @export
 */
export const InteractionEventBeanTypeEnum = {
    View: 'VIEW',
    Click: 'CLICK',
    Conversion: 'CONVERSION'
} as const;
export type InteractionEventBeanTypeEnum = typeof InteractionEventBeanTypeEnum[keyof typeof InteractionEventBeanTypeEnum];


/**
 * Check if a given object implements the InteractionEventBean interface.
 */
export function instanceOfInteractionEventBean(value: object): boolean {
...
export function InteractionEventBeanFromJSON(json: any): InteractionEventBean {
    return InteractionEventBeanFromJSONTyped(json, false);
}

export function InteractionEventBeanFromJSONTyped(json: any, ignoreDiscriminator: boolean): InteractionEventBean {
    if (json == null) {
        return json;
    }
    return {
...
export function InteractionEventBeanToJSON(value?: InteractionEventBean | null): any {
    if (value == null) {
        return value;
    }
    return {
