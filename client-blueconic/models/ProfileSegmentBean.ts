 ...
 * 
 * @export
 * @interface ProfileSegmentBean
 */
export interface ProfileSegmentBean {
    /**
     * The ID of the segment.
     * @type {string}
     * @memberof ProfileSegmentBean
     */
    id?: string;
    /**
...
/**
 * Check if a given object implements the ProfileSegmentBean interface.
 */
export function instanceOfProfileSegmentBean(value: object): boolean {
    return true;
}

export function ProfileSegmentBeanFromJSON(json: any): ProfileSegmentBean {
    return ProfileSegmentBeanFromJSONTyped(json, false);
}

export function ProfileSegmentBeanFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProfileSegmentBean {
    if (json == null) {
        return json;
    }
    return {
...
export function ProfileSegmentBeanToJSON(value?: ProfileSegmentBean | null): any {
    if (value == null) {
        return value;
    }
    return {
