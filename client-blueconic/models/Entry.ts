...
import type { InteractionType } from './InteractionType.js';
import {
    InteractionTypeFromJSON,
    InteractionTypeFromJSONTyped,
...
export function EntryFromJSONTyped(json: any, ignoreDiscriminator: boolean): Entry {
    ...
    return {
        ...
        'interactionType': json['interactionType'] == null ? undefined : InteractionTypeFromJSON(json['interactionType']),
...
export function EntryToJSON(value?: Entry | null): any {
    ...
    return {
        ...
        'id': value['id'],
        'interactionType': InteractionTypeToJSON(value['interactionType']),
        'name': value['name'],
