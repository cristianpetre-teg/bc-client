...
import type { SimpleDomain } from './SimpleDomain.js';
import {
    SimpleDomainFromJSON,
    SimpleDomainFromJSONTyped,
    SimpleDomainToJSON,
} from './SimpleDomain.js';

/**
 * The channels.
 * @export
 * @interface ChannelBeanV2SchemaForChannelsV2
 */
export interface ChannelBeanV2SchemaForChannelsV2 {
    /**
     * The aliases of the channel. Alternative hostnames, only applicable to web channels. For example, an alias of the hostname `www.blueconic.com` could be `blueconic.com`.
     * @type {Array<string>}
     * @memberof ChannelBeanV2SchemaForChannelsV2
     */
    ...
    domain?: SimpleDomain;
    /**
     * The hostname of the channel. For web channels, the hostname of the website, excluding the protocol (e.g. `https://`) and path (e.g. `/`). For mobile channels, the App ID. For email channels, the hostname is empty.
     * @type {string}
     * @memberof ChannelBeanV2SchemaForChannelsV2
     */
    hostname?: string;
     ...
     * @memberof ChannelBeanV2SchemaForChannelsV2
     */
    type?: ChannelBeanV2SchemaForChannelsV2TypeEnum;
    /**
     * The visitor count of the channel.
     * @type {number}
     * @memberof ChannelBeanV2SchemaForChannelsV2
     */
    visitorCount?: number;
 ...
 * @export
 */
export const ChannelBeanV2SchemaForChannelsV2TypeEnum = {
    Email: 'EMAIL',
    Mobile: 'MOBILE',
    Website: 'WEBSITE'
} as const;
export type ChannelBeanV2SchemaForChannelsV2TypeEnum = typeof ChannelBeanV2SchemaForChannelsV2TypeEnum[keyof typeof ChannelBeanV2SchemaForChannelsV2TypeEnum];


/**
 * Check if a given object implements the ChannelBeanV2SchemaForChannelsV2 interface.
 */
export function instanceOfChannelBeanV2SchemaForChannelsV2(value: object): boolean {
    return true;
}

export function ChannelBeanV2SchemaForChannelsV2FromJSON(json: any): ChannelBeanV2SchemaForChannelsV2 {
    return ChannelBeanV2SchemaForChannelsV2FromJSONTyped(json, false);
}

export function ChannelBeanV2SchemaForChannelsV2FromJSONTyped(json: any, ignoreDiscriminator: boolean): ChannelBeanV2SchemaForChannelsV2 {
    if (json == null) {
        return json;
    }
    return {
        ...
        'domain': json['domain'] == null ? undefined : SimpleDomainFromJSON(json['domain']),
...
export function ChannelBeanV2SchemaForChannelsV2ToJSON(value?: ChannelBeanV2SchemaForChannelsV2 | null): any {
    if (value == null) {
        return value;
    }
    return {
