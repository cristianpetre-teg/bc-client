...
/**
 * Check if a given object implements the ErrorBean interface.
 */
export function instanceOfErrorBean(value: object): boolean {
    return true;
}

export function ErrorBeanFromJSON(json: any): ErrorBean {
    return ErrorBeanFromJSONTyped(json, false);
}

export function ErrorBeanFromJSONTyped(json: any, ignoreDiscriminator: boolean): ErrorBean {
    if (json == null) {
        return json;
    }
    return {
...
export function ErrorBeanToJSON(value?: ErrorBean | null): any {
    if (value == null) {
        return value;
    }
    return {
